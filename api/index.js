...
// ✅ Use environment PORT for Vercel/Render
...
// Fallback sample data (keeping your existing functions)
function getSampleProfitLoss() {
  return [
    { year: 'Mar 2024', sales: '240893', net_profit: '44324', opm_percentage: '27.2', eps: '18.45' },
    { year: 'Mar 2023', sales: '220000', net_profit: '40000', opm_percentage: '26.8', eps: '17.20' },
    { year: 'Mar 2022', sales: '200000', net_profit: '36000', opm_percentage: '25.5', eps: '15.80' }
  ];
}
...
app.get('/api/company/:id', async (req, res) => {
  ...
  try {
    ...
    if (companyError || !companyData) {
      // Return fallback for unknown company
      return res.json({
        id: companyId,
        company_name: `${companyId} Limited`,
        analysis: [],
    ...
    for (const companyId of companyList) {
      ...
      if (!analysisError && analysisData && analysisData.length > 0) {
        ...
        if (profitLossData && profitLossData.length > 0) {
          ...
          operatingMargin = parseFloat(latest.opm_percentage) || 0;
        }
...
if (process.env.NODE_ENV !== 'production') {
  app.listen(PORT, () => {
    ...
    console.log(`📊 Database: ${databaseConnected ? 'Supabase Connected' : 'Fallback Mode'}`);
  });
}
